...
void ParticleContactResolver::updateInterpenetration(ParticleContact *contactArray, unsigned numContacts, unsigned maxIndex)
{
                                              ...
                                              float duration)
{
    ...
    while(iterationsUsed < iterations)
    {
		...
		updateInterpenetration(contactArray, numContacts, maxIndex);
...
{
	//if penetration = 0, then nothing happens.
	if (penetration <= 0)
		return;
	...
	//0 inverse mass = infinte mass, if this occurs, nothing happens
